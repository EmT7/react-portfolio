  ...
  return (
    <section className="my-5">
      ...
      <div className="my-2">
        ...
        <p>
        My desire is that my portfolio will showcase my personality and new talents as a web developer and overall give you a sneak peek at who I am! Please feel free to reach out with any opportunities and most of all, enjoy my page!
        </p>
      </div>
    </section>
  );
